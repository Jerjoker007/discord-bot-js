...
module.exports = {
   ...
   */
  callback: async (ravi: any, interaction: any) => {
    ...
    if (targetUserRolePosition >= requestUserRolePosition) {
      await interaction.editReply("You can't ban a user with the same/higher role.")
      return;
    }

    if (targetUserRolePosition >= botRolesPosition) {
      await interaction.editReply("I can't ban a user with the same/higher role.")
      return;
    }
